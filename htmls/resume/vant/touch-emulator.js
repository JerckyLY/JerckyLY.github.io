...
!function () {
    if ("undefined" != typeof window) {
        ...
        document.createTouch || (document.createTouch = function (e, t, o, u, c, i, r) {
            return new n(t, o, {
                pageX: u,
                pageY: c,
                screenX: i,
    ...
    function c(t) {
        return function (n) {
            var u, c, s;
            ("mousedown" === n.type && (o = !0), "mouseup" === n.type && (o = !1), "mousemove" !== n.type || o) && (("mousedown" === n.type || !e || e && !e.dispatchEvent) && (e = n.target), null == e.closest("[data-no-touch-simulate]") && (u = t, c = n, (s = document.createEvent("Event")).initEvent(u, !0, !0), s.altKey = c.altKey, s.ctrlKey = c.ctrlKey, s.metaKey = c.metaKey, s.shiftKey = c.shiftKey, s.touches = r(c), s.targetTouches = r(c), s.changedTouches = i(c), e.dispatchEvent(s)), "mouseup" === n.type && (e = null))
        }
    }
    ...
    function s() {
        window.addEventListener("mousedown", c("touchstart"), !0), window.addEventListener("mousemove", c("touchmove"), !0), window.addEventListener("mouseup", c("touchend"), !0)
    }
}();
